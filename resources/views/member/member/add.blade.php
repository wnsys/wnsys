...
@section('message')
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" class="form-control password" name="info[password]" v-model="{{$action}}_password" >
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-4">确认密码</label>
                <div class="col-md-5">
                    <input type="text" class="form-control check_password" name="info[check_password]" v-model="{{$action}}_check_password">
                </div>
            </div>
@overwrite
@section("footer")
