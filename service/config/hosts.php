...
return [
    "http" => [
        [
            ...
            'max_request' => 1000,
            'pid_file' => app()->basePath()."/bootstrap/swoole-http-9600.pid",
        ...
        [
            ...
            // like pm.max_requests in php-fpm
            'max_request' => 1000,
            'pid_file' => app()->basePath()."/bootstrap/swoole-http-9601.pid",
            'log_file' => app()->storagePath().'/logs/swoole.log',
            "port" => 9601,
            "host" => '127.0.0.1'
        ]
    ...
    "socket" => [
        [
            ...
            // like pm.max_requests in php-fpm
            'max_request' => 1000,
            'pid_file' => app()->basePath()."/bootstrap/swoole-http-9701.pid",
            'log_file' => app()->storagePath().'/logs/swoole.log',
            "port" => 9700,
            "host" => '127.0.0.1'
        ],
